package com.cloudok.management.swagger;
...
public class ManagementSwaggerConfigure {
	...
	@Bean
	public Docket managementSwagger() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo).groupName("management").select()
				.apis(!("dev".equals(active) || "local".equals(active) || "test".equals(active))
						? RequestHandlerSelectors.none()
						: RequestHandlerSelectors.basePackage("com.cloudok.management.api"))
