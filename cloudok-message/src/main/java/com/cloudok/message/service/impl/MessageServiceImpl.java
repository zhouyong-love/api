...
import com.cloudok.message.configure.MessageProperties;
import com.cloudok.message.configure.MessageProperties.MessageBusiness;
import com.cloudok.message.enums.MessageStatus;
import com.cloudok.message.exception.MessageExceptionMessges;
import com.cloudok.message.mapper.MessageMapper;
...
public class MessageServiceImpl extends AbstractService<MessageVO, MessagePO> implements MessageService{
	...
	public Page<MessageVO> iipage(QueryBuilder builder) {
		...
		builder.and(MessageMapping.MESSAGETYPE,QueryOperator.EQ,com.cloudok.message.enums.MessageType.II.getValue());
